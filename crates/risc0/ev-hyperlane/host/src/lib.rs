...
// This generates constants like: EV_HYPERLANE_GUEST_ID, EV_HYPERLANE_GUEST_PATH, etc.
risc0_zkvm::guest::host::include_methods!();

// Re-export the guest module for compatibility
pub use ev_hyperlane_guest::*;

// Export the ImageID for use in the prover
pub const EV_HYPERLANE_ID: [u8; 32] = {
    const ID_U32: [u32; 8] = EV_HYPERLANE_GUEST_ID;
